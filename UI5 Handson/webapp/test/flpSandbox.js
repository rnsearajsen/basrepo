		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400 Handson",
									"targetURL": "#ux400trainingux400handson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ux400trainingux400handson-display": {
								"semanticObject": "ux400trainingux400handson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux400.training.ux400handson",
									"url": sap.ui.require.toUrl("ux400/training/ux400handson")
								}
							}
						}
					}
